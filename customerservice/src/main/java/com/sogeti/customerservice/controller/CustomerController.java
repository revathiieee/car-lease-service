...
public class CustomerController {
     ...
     */
    @PostMapping("/")
    public ResponseEntity<Customer> createCustomer(@RequestBody CustomerRequest customerRequest, @RequestHeader(value = "Authorization", required = false) String token) {
